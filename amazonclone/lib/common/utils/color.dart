...
class MyColors {
  MyColors._();
  static const Color signinandsignupColors = Color(0xFFF6F6F6);
  ...
  static const Color buttonColor = Color(0xFFFA7436);
  static const Color primayText = Color.fromARGB(255, 82, 76, 73);
}
